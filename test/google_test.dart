...
import 'package:auth_social_buttons/src/button.dart';
...
void main() {
  ...
  testWidgets('Check dark mode works', (WidgetTester tester) async {
    ...
    var button = find.byType(ElevatedButton).evaluate().toList()[0].widget
        as ElevatedButton;
    expect(button, Color(0xFF4285F4));
  ...
  testWidgets('Check default splash color is used',
    ...
    var button = find.byType(ElevatedButton).evaluate().toList()[0].widget
        as ElevatedButton;
    expect(buttonTheme.getSplashColor(button as MaterialButton),
        buttonTheme.getTextColor(button as MaterialButton).withOpacity(0.12));
  });
}
